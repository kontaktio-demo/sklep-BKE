...
// Linia Dog Store Pro: sprzet sluzbowy. Te produkty NIE pojawiaja sie w zwyklym sklepie.
...
function variantsFor(spec: ProSpec): ProductVariant[] {
  const model = (spec.slug.split("-")[0] ?? spec.slug).slice(0, 3).toUpperCase();
  const trunk = `DSP-${model}-${spec.width.replace(".", "")}`;
...
function pro(spec: ProSpec): Product {
  const model = (spec.slug.split("-")[0] ?? spec.slug).slice(0, 3).toUpperCase();
  ...
  return {
    ...
    line: "pro",
    proCategory: spec.proCategory,
    proStandard: spec.proStandard,
  };
}
...
export const proProducts: Product[] = [
  pro({
    slug: "patrol-duty-collar",
    name: "Obroża patrolowa Pro Patrol",
    ...
    proCategory: "patrol",
    proStandard: "Klasa robocza / patrol",
    width: "1.75",
    type: "nylon",
  ...
  pro({
    slug: "grip-handle-collar",
    name: "Obroża z uchwytem Pro Grip",
    ...
    proCategory: "handle",
    proStandard: "Klasa robocza / interwencja",
    width: "1.75",
    type: "nylon",
    idPanelCompatible: true,
    badges: ["bestseller"],
  ...
  pro({
    slug: "breach-handle-collar",
    name: "Obroża z uchwytem Pro Breach",
  ...
  pro({
    slug: "mount-e-collar",
    name: "Obroża pod moduł Pro Mount",
    ...
    weightStep: 18,
    colors: [C.czarny, C.oliwkowy],
    proCategory: "e-collar",
    proStandard: "Zgodna z modułami do 45 mm",
    width: "1.5",
    type: "nylon",
  ...
  pro({
    slug: "relay-e-collar",
    name: "Obroża pod moduł Pro Relay",
  ...
  pro({
    slug: "drill-training-collar",
    name: "Obroża szkoleniowa Pro Drill",
    ...
    proCategory: "training",
    proStandard: "Klasa robocza / szkolenie",
    width: "1.5",
    type: "nylon",
    idPanelCompatible: false,
    bestsellerRank: 3,
  ...
  pro({
    slug: "check-training-chain",
    name: "Obroża półzaciskowa Pro Check",
  ...
  pro({
    slug: "scent-detection-collar",
    name: "Obroża do pracy węchowej Pro Scent",
    ...
    proCategory: "detection",
    proStandard: "Klasa robocza / detekcja",
    width: "1.5",
    type: "nylon",
    idPanelCompatible: true,
    bestsellerRank: 7,
  ...
  pro({
    slug: "track-detection-collar",
    name: "Obroża do tropienia Pro Track",
  ...
  pro({
    slug: "sentry-patrol-collar",
    name: "Obroża patrolowa Pro Sentry",
  ...
  pro({
    slug: "anchor-patrol-collar",
    name: "Obroża patrolowa Pro Anchor",
  ...
  pro({
    slug: "cadet-training-collar",
    name: "Obroża szkoleniowa Pro Cadet",
...
const CATEGORY_META: Record<ProCategory, { code: string; title: string; description: string }> = {
  patrol: {
    code: "PRO-01",
    title: "Patrol",
    description:
...
export const proCategories: ProCategoryInfo[] = (
  Object.keys(CATEGORY_META) as ProCategory[]
).map((slug) => ({
  slug,
  ...CATEGORY_META[slug],
  productCount: proProducts.filter((p) => p.proCategory === slug).length,
}));
