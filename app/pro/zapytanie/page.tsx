...
export const metadata: Metadata = {
  title: { absolute: "Zapytanie ofertowe | Dog Store Pro" },
  description:
    "Zapytanie ofertowe na sprzęt z linii Dog Store Pro dla jednostek, hodowli i szkół tresury. Wycena, terminy, znakowanie.",
};
    ...
    <div className="bg-nf-bg">
      <section className="border-b border-nf-border">
        <div className={`${CONTAINER} py-16 md:py-24`}>
          ...
          <Breadcrumbs
            mono
            items={[{ label: "Dog Store Pro", href: "/pro" }, { label: "Zapytanie ofertowe" }]}
          />
