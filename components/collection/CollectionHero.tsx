...
// wygladala tanio.
export async function CollectionHero({ collection }: { collection: Collection }) {
  ...
  return (
    <section className="border-b border-nf-border bg-nf-bg">
      <div className="mx-auto max-w-[1600px] px-4 pb-12 pt-10 md:px-6 md:pb-16 md:pt-14">
        <nav aria-label={t("hero.breadcrumbAria")} className="mb-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end lg:gap-16">
          <div className="max-w-3xl">
            ...
            <p className="type-label text-nf-dim">{t("hero.eyebrow")}</p>
